...
Uppercase vs Lowercase can be a contentious topic, capitalisation is best for in a production code for ease of reading. For everything else lowercase is fine as most modern coding tools have highlighting to save yourself toggling caps lock. The main thing is consistency.  
